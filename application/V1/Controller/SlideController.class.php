...
class SlideController extends WechatController
{
    ...
    {
        parent::_initialize();
        $this->slide_model = D("V1/Slide");
        $this->slidecat_model = D("V1/SlideCat");
    }
    ...
    {
        $where = array();
        $where['wid'] = $this->wechat_config['id'];
    ...
    public function add_post()
    {
        if (IS_POST) {
            if ($this->slide_model->create() !== false) {
                $this->slide_model->wid = $this->wechat_config['id'];
